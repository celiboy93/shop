...
interface User {
    ...
    lifetimeSpend: number; // NEW
    tier: keyof typeof TIER_THRESHOLDS; // NEW
}
...
async function updateUserSpendAndTier(username: string, spendChange: number): Promise<boolean> {
    ...
    while (true) {
        ...
        const newLifetimeSpend = (user.lifetimeSpend || 0) + spendChange;
...
async function registerUser(username: string, passwordHash: string): Promise<boolean> {
    ...
    // NEW: Initialize lifetimeSpend and tier
    ...
    const html = `
        ...
        <body><div class="container" style="max-width: 800px;">
            ...
            <div class="balance-box">
                <div class="balance-label">Welcome, ${user.username}! (Tier: ${user.tier})</div>
    ...
    const html = `
        ...
        <div class="profile-header">
            ...
            <div class="profile-info">
                <h1 class="profile-name" id="username-text">${user.username} (Tier: ${user.tier})</h1>
